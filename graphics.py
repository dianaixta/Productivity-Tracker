...
class GraphWin(tk.Canvas):
    ...
    def __init__(self, title="Graphics Window",
        ...
        self.bind("<B1-Motion>", self._onMouseDrag)
    ...
    def checkDrag(self):
        ...
        Returns True if the button is being held down, False otherwise.
        """
        self.update()
        return self.mouseX is not None and self.mouseY is not None

    def getDrag(self):
        """
        Get the current location of the mouse if the left mouse button is being
        held down. Returns a Point object if the mouse is being dragged, None
        otherwise
        """
        self.update()
